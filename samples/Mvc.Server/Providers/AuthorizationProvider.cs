...
namespace Mvc.Server.Providers
{
    public sealed class AuthorizationProvider : OpenIdConnectServerProvider
    {
        public override async Task ValidateAuthorizationRequest(ValidateAuthorizationRequestContext context)
        {
            ...
            var application = await (from entity in database.OpenIdApplications
        ...
        public override async Task ValidateLogoutRequest(ValidateLogoutRequestContext context)
        {
            ...
            if (!string.IsNullOrEmpty(context.PostLogoutRedirectUri) &&
                !await database.OpenIdApplications.AnyAsync(application => application.LogoutRedirectUri == context.PostLogoutRedirectUri))
            {
                context.Reject(
                    error: OpenIdConnectConstants.Errors.InvalidRequest,
